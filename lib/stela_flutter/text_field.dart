...
import 'selection.dart' as StelaSelection;
...
class _TextFieldSelectionGestureDetectorBuilder
    extends StelaSelection.TextSelectionGestureDetectorBuilder {
...
class TextField extends StatefulWidget {
  const TextField({
    ...
    this.textDirection,
    this.readOnly = false,
    StelaEditableText.ToolbarOptions toolbarOptions,
    this.showCursor,
    ...
    this.scrollPhysics,
        ...
        toolbarOptions = toolbarOptions ??
            (obscureText
                ? const StelaEditableText.ToolbarOptions(
                    selectAll: true,
                    paste: true,
                  )
                : const StelaEditableText.ToolbarOptions(
  ...
  final StelaEditableText.TextEditingController controller;
  ...
  /// showing when it is tapped by calling [StelaEditableText.EditableTextState.requestKeyboard()].
  ...
  final StelaEditableText.ToolbarOptions toolbarOptions;
  ...
  void debugFillProperties(DiagnosticPropertiesBuilder properties) {
    ...
    properties.add(DiagnosticsProperty<StelaEditableText.TextEditingController>(
...
class _TextFieldState extends State<TextField>
    implements StelaSelection.TextSelectionGestureDetectorBuilderDelegate {
  StelaEditableText.TextEditingController _controller;
  StelaEditableText.TextEditingController get _effectiveController =>
  ...
  // API for StelaSelection.TextSelectionGestureDetectorBuilderDelegate.
  @override
  bool forcePressEnabled;

  @override
  final GlobalKey<StelaEditableText.EditableTextState> editableTextKey =
      GlobalKey<StelaEditableText.EditableTextState>();

  @override
  bool get selectionEnabled => widget.selectionEnabled;
  // End of API for StelaSelection.TextSelectionGestureDetectorBuilderDelegate.
  ...
  void didUpdateWidget(TextField oldWidget) {
    ...
    if (widget.controller == null && oldWidget.controller != null)
      _controller = StelaEditableText.TextEditingController.fromValue(
  ...
  StelaEditableText.EditableTextState get _editableText =>
  ...
  Widget build(BuildContext context) {
    ...
    Widget child = RepaintBoundary(
      child: StelaEditableText.EditableText(
        key: editableTextKey,
