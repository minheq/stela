...
class StelaBlockText extends MultiChildRenderObjectWidget {
  ...
  RenderBlockText createRenderObject(BuildContext context) {
    return RenderBlockText(
      ...
      selection: TextSelection(baseOffset: 1, extentOffset: 70),
      offset: offset,
...
class RenderBlockText extends RenderParagraph {
  ...
  Rect getLocalRectForCaret(TextPosition caretPosition) {
    final Offset caretOffset =
        _textPrototype.getOffsetForCaret(caretPosition, _caretPrototype);
    // This rect is the same as _caretPrototype but without the vertical padding.
    Rect rect =
        Rect.fromLTWH(0.0, 0.0, cursorWidth, _textPrototype.preferredLineHeight)
            .shift(caretOffset);
  ...
  void paint(PaintingContext context, Offset offset) {
    ...
    if (_floatingCursorOn) {
      if (_resetFloatingCursorAnimationValue == null)
        _paintCaret(context.canvas, offset, _floatingCursorTextPosition);
